...
```{r, echo=FALSE}
Cancerfinall = Cancergraph
write.csv(Cancerfinall, "Cancer_final_noNA.csv", row.names=FALSE, quote=FALSE) #to save the file into our environment
...
ggarrange(graphAge, graphAlco, graphGDP, graphObes, graphPoll, graphSmoke + rremove("x.text"), ncol = 2, nrow = 3)
```