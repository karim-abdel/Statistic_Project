...
# Installation
THIS PART IS NOT VERY INTERESTING

Make sure you have the newest versions of R and RStudio. R should be 4.1.0 "Camp Pontanezen" or higher (in case you are wondering, the interesting version names come from [Peanut cartoons](https://livefreeordichotomize.com/2018/04/23/r-release-names/)) and RStudio should be 1.4.1717 or higher.
...
<center>
![Anakin says, "I knitted the .Rmd file to create the .html file." To which Padme replies, "And you know ehre it is because you saved it somewhere other your downloads folder, right?"](good-name-meme.jpg){width="50%"}
</center>

3. If I do not give you a file to start from, use the R markdown template that you can download below.  
